        ...
        <form >
            <div className='flex flex-col md:flex-row  w-full md:gap-10' >
                <div className='w-full'>
                    <label htmlFor="name" className="block text-2xl font-medium text-gray-700 ml-2 mt-8">{t("contactUs.fname")}</label>
                ...
                <div className='w-full'>
                    <label htmlFor="name" className="block text-2xl font-medium text-gray-700 ml-2 mt-8">{t("contactUs.lname")}</label>
                    <input type="text" id="name" name="name" required
                        className="mt-2 w-full px-5 py-5 border border-gray-300 rounded-3xl shadow-sm focus:outline-none focus:ring-primary focus:border-primary  "
            ...
            <div>
                <label htmlFor="mobile" className="block text-2xl font-medium text-gray-700 ml-2 mt-8">{t("contactUs.email")}</label>
            ...
            <div>
                <label htmlFor="mobile" className="block text-2xl font-medium text-gray-700 ml-2 mt-8">{t("contactUs.no")}</label>
            ...
            <div>
                <label htmlFor="location" className="block text-2xl font-medium text-gray-700 ml-2 mt-8">{t("contactUs.location")}</label>
            ...
            <div>
                <label htmlFor="service" className="block text-2xl font-medium text-gray-700 ml-2 mt-8">{t("contactUs.sreq")}</label>
                <input type="text" id="service" name="service"
                    className="mt-2 block w-full px-5 py-5 border border-gray-300 rounded-3xl shadow-sm focus:outline-none focus:ring-primary focus:border-primary  "
                    placeholder={serviceName} />
            </div>
            <div className='mt-10 flex justify-center '>
                <Button name={t("contactUs.start")} style="bg-primary text-white hover:bg-third text-center hover:text-primary hover:border border-primary text-2xl" />
            </div>
        </form>
    </div>
