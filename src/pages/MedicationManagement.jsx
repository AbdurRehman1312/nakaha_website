  ...
  return (
    ...
    <section className="container m-auto px-2 my-10">
         ...
         <div className=' lg:mx-36 mt-12'>
             <h1 className="text-xl md:text-2xl lg:text-3xl text-primary">{t("blogCard4.head2")}</h1>
             <p className='mt-6 text-2xl text-justify'>{t("blogCard4.para2")}</p>
            ...
            <p className='mt-6 text-2xl text-justify'>{t("blogCard4.para3")}</p>
         </div>
         ...
         <div className=' lg:mx-36 mt-12'>
             <h1 className="text-xl md:text-2xl lg:text-3xl text-primary">{t("blogCard4.head7")}</h1>
             <p className='mt-7 text-2xl text-justify'>{t("blogCard4.para7")}</p>
         </div>
         <div className=' lg:mx-36 mt-12'>
             <h1 className="text-xl md:text-2xl lg:text-3xl text-primary">{t("blogCard4.head8")}</h1>
             <p className='mt-8 text-2xl text-justify'>{t("blogCard4.para8")}</p>
         </div>
  </section>
    </>
  )
