    ...
    return (
      ...
      <section className="container m-auto px-2 my-10">
           ...
           <div className=' lg:mx-36 mt-12'>
               <h1 className="text-3xl text-primary">{t("blogCard2.head2")}</h1>
               <p className='mt-6 text-2xl md:text-justify'>{t("blogCard2.para2")}</p>
               <p className='mt-6 text-2xl md:text-justify'>{t("blogCard2.para3")}</p>
           ...
           <div className=' lg:mx-36 mt-12'>
               <h1 className="text-3xl text-primary">{t("blogCard2.head4")}</h1>
               <p className='mt-6 text-2xl md:text-justify'>{t("blogCard2.para4")}</p>
               <ul className='list-disc mt-10 ml-5'>
           ...
           <div className=' lg:mx-36 mt-12'>
               <h1 className="text-3xl text-primary">{t("blogCard2.head5")}</h1>
               <ul className='list-disc mt-10 ml-5'>
