                ...
                <div className='pt-12 pb-16'>
                    ...
                    <Accordion type="single" collapsible className='mt-16'>
                        <AccordionItem value="item-1">
                            <AccordionTrigger>{t("eachService.vascular.faq1")}</AccordionTrigger>
                            <AccordionContent>
                                {t("eachService.vascular.ans1")}
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-2">
                            <AccordionTrigger>{t("eachService.vascular.faq2")}</AccordionTrigger>
                            <AccordionContent>
                                {t("eachService.vascular.ans2")}
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-3">
                            <AccordionTrigger>{t("eachService.vascular.faq3")}</AccordionTrigger>
                            <AccordionContent>
                                {t("eachService.vascular.ans3")}
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
                </div>
